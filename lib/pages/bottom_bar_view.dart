...
class TabIconData {
  ...
  static List<TabIconData> tabIconsList = <TabIconData>[
    TabIconData(
      imagePath: 'assets/bottom_bar_buttons/home.png',
      selectedImagePath: 'assets/bottom_bar_buttons/home_s.png',
      index: 0,
      isSelected: true,
      animationController: null,
    ),
    TabIconData(
      imagePath: 'assets/bottom_bar_buttons/notes.png',
      selectedImagePath: 'assets/bottom_bar_buttons/notes_s.png',
      index: 1,
      isSelected: false,
      animationController: null,
    ),
    TabIconData(
      imagePath: 'assets/bottom_bar_buttons/graph.png',
      selectedImagePath: 'assets/bottom_bar_buttons/graph_s.png',
      index: 2,
      isSelected: false,
      animationController: null,
    ),
